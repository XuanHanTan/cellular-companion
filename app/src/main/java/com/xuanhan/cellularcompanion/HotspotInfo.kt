...
fun HotspotInfo(navigator: DestinationsNavigator) {
    ...
    Scaffold(topBar = {
        ...
        Column(
            ...
            Text(
                "Enter this device's mobile hotspot credentials in the following fields. They will be sent to your Mac to allow your Mac to connect to your hotspot automatically.",
